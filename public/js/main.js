...
const wind_dust = document.getElementById('wind_dust');
const wind_degree = document.getElementById('wind_degree');
// console.log(cityName);
// console.log(wind_degree);
// console.log(wind_dust);
// console.log(wind_speed);
const city_name = document.getElementById('city_name')
const tem_real_val = document.getElementById('temp_real_val');
...
const getInfo = async(event) => {
    ...
    if(cityVal === ""){
        ...
        try{
            ...
            const arrData = [data];
            wind_speed.innerText = arrData[0].wind.speed + "m/s";
            wind_degree.innerText = arrData[0].wind.deg+"°";
            wind_dust.innerText = arrData[0].wind.gust;
            // console.log(arrData[0].wind);
            // console.log(arrData[0].wind.deg);
